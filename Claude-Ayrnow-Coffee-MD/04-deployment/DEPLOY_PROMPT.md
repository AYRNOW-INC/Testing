...
- Remote: `git@github.com:AYRNOW-INC/AYRNOW-MVP.git` (private)
- Branch: `main`
...
# Set secrets
gh secret set AWS_ACCESS_KEY_ID --repo AYRNOW-INC/AYRNOW-MVP --body "<FROM_STEP_3>"
gh secret set AWS_SECRET_ACCESS_KEY --repo AYRNOW-INC/AYRNOW-MVP --body "<FROM_STEP_3>"
...
gh secret set EB_ENVIRONMENT_NAME --repo AYRNOW-INC/AYRNOW-MVP --body "ayrnow-backend-env"
```
...
# Watch the run
gh run list --repo AYRNOW-INC/AYRNOW-MVP --limit 1
