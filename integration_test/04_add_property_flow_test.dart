...
void main() {
  ...
  testWidgets('TC-04: Add Property Flow', (tester) async {
    ...
    debugPrint('[TC-04-01] Login as landlord');
    ...
    debugPrint('[TC-04-01] PASS');

    // TC-04-02: Navigate to Properties tab
    debugPrint('[TC-04-02] Navigate to Properties');
    await tapNavTab(tester, 'Properties');
    await tester.pumpAndSettle(const Duration(seconds: 2));
    expect(find.text('Properties'), findsWidgets);
    debugPrint('[TC-04-02] PASS');

    // TC-04-03: Tap Add Property
    debugPrint('[TC-04-03] Tap Add Property');
    ...
    debugPrint('[TC-04-03] PASS');

    // TC-04-04: Fill property info
    debugPrint('[TC-04-04] Fill property details');
    ...
    debugPrint('[TC-04-08] PASS');

    FlutterError.onError = originalOnError;

    debugPrint('');
    debugPrint('========================================');
    debugPrint('  TC-04: ADD PROPERTY — ALL PASS');
    debugPrint('========================================');
  });
}
