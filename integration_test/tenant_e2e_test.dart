...
void main() {
  ...
  setUpAll(() {
    ...
    print('>> Tenant E2E starting with:');
    print('   Email: $tenantEmail');
  ...
  testWidgets('Tenant E2E: Accept Invite → Register → Onboard → Pay',
    ...
    print('>> Step 3: Enter invite code: $inviteCode');
    ...
    print('>> Step 4: Invite Accept Screen');
    ...
    print('>> Step 5: Set password on verification screen');
    ...
    print('>> Step 6: Register as tenant');
    ...
    print('>> Step 7: Select Tenant role');
