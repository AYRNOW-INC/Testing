...
void main() {
  ...
  testWidgets('TC-01: Landlord Registration Flow', (tester) async {
    ...
    print('[TC-01-01] Splash screen loads');
    expect(find.text('Login'), findsOneWidget);
    expect(find.text('Create Account'), findsOneWidget);
    print('[TC-01-01] PASS');

    // TC-01-02: Tap Create Account → Register Step 1
    print('[TC-01-02] Navigate to Register Step 1');
    ...
    print('[TC-01-03] Fill personal info');
    ...
    print('[TC-01-04] Navigate to Step 2');
    ...
    print('[TC-01-05] Complete registration as Landlord');
    ...
    print('');
    print('========================================');
    print('  TC-01: LANDLORD REGISTRATION — ALL PASS');
    print('  Email: $email');
    print('========================================');
  });
}
