...
void main() {
  ...
  testWidgets('TC-02: Tenant Registration Flow', (tester) async {
    ...
    debugPrint('[TC-02-01] Splash → Register Step 1');
    await tester.tap(find.text('Create Account'));
    await tester.pumpAndSettle(const Duration(seconds: 2));
    expect(find.text('Personal Information'), findsOneWidget);
    debugPrint('[TC-02-01] PASS');

    // TC-02-02: Fill personal info
    debugPrint('[TC-02-02] Fill tenant personal info');
    ...
    debugPrint('[TC-02-02] PASS');

    // TC-02-03: Step 2 → Select Tenant
    debugPrint('[TC-02-03] Select Tenant role');
    ...
    debugPrint('[TC-02-03] PASS');

    // TC-02-04: Continue → Tenant Dashboard
    debugPrint('[TC-02-04] Complete registration → Tenant Dashboard');
    ...
    debugPrint('[TC-02-04] PASS');

    FlutterError.onError = originalOnError;

    debugPrint('');
    debugPrint('========================================');
    debugPrint('  TC-02: TENANT REGISTRATION — ALL PASS');
